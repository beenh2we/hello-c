...
float max_int_float(int a, float b) { return a > b ? a : b; }
double max_int_double(int a, double b) { return a > b ? a : b; }
float max_float_int(float a, int b) { return a > b ? a : b; }
double max_float_double(float a, double b) { return a > b ? a : b; }
double max_double_int(double a, int b) { return a > b ? a : b; }
double max_double_float(double a, float b) { return a > b ? a : b; }
...
void printf_int(int x) { printf("Integer: %d\n", x); }
void printf_uint(unsigned int x) { printf("Unsigned integer: %u\n", x); }
void printf_long(long x) { printf("Long: %ld\n", x); }
void printf_ulong(unsigned long x) { printf("Unsigned long: %lu\n", x); }
void printf_float(float x) { printf("Float: %f\n", x); }
void printf_double(double x) { printf("Double: %lf\n", x); }
void printf_str(char* x) { printf("String: %s\n", x); }
void printf_ptr(void* x) { printf("Pointer: %p\n", x); }
void printf_unknown(void* x) { printf("Unknown type at: %p\n", (void*)x); }
