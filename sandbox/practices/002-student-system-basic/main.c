...
int main(int argc, char *argv[])
{
    ...
    do
    {
        ...
        case 1:
            ...
            {
                input_student_data(student_names, student_scores, student_count);
                data_entered = true;
            }
            else
            {
        ...
        case 2:
            if (data_entered)
            {
                display_student_data(student_names, student_scores, student_count);
            }
            else
            {
        ...
        case 3:
            if (data_entered)
            {
                float average = calculate_average(student_scores, student_count);
        ...
        case 4:
            if (data_entered)
            {
                float highest = find_highest_score(student_scores, student_count);
