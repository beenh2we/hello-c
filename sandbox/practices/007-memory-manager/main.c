...
BlockPool* get_pool_for_category(BlockCategory category) {
    switch (category) {
        case BLOCK_TINY: return &g_memory_manager.tiny_pool;
        case BLOCK_SMALL: return &g_memory_manager.small_pool;
        case BLOCK_MEDIUM: return &g_memory_manager.medium_pool;
        default: return NULL;
    }
}
