...
void basic_struct_initializers() {
    ...
    printf("  Name: %s, Age: %d, Height: %.2f m, Weight: %.1f kg\n", 
           person1.name, person1.age, person1.height, person1.weight);
    ...
    printf("  Name: %s, Age: %d, Height: %.2f m, Weight: %.1f kg\n", 
           person2.name, person2.age, person2.height, person2.weight);
...
void nested_designated_initializers() {
    ...
    printf("  Purchased on: %d-%02d-%02d\n", 
           my_car.purchase_date.year, my_car.purchase_date.month, my_car.purchase_date.day);
    printf("  Price: $%.2f\n", my_car.price);
}
...
void sparse_arrays() {
    ...
    printf("[0]=%d, [10]=%d, [20]=%d, [50]=%d, [99]=%d\n", 
           sparse[0], sparse[10], sparse[20], sparse[50], sparse[99]);
